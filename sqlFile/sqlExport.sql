...
INSERT INTO `categories` VALUES (1,'smart watches'),(2,'Headphones'),(3,'Accessories');
...
INSERT INTO `products` VALUES (1,'A smartwatch with health tracking, GPS, and long battery life',5,'default.png',150,'Smartwatch X100',50,142.5,1,NULL),(2,'Noise-cancelling wireless earbuds with superior sound quality',15,'default.png',80,'Wireless Earbuds Pro',200,68,1,NULL),(3,'High-performance gaming laptop with a 4K display and powerful GPU',20,'default.png',1200,'Gaming Laptop GX',20,960,3,NULL);
...
INSERT INTO `user_role` VALUES (1,1),(3,1),(2,2),(3,2),(3,3);
...
INSERT INTO `users` VALUES (1,'user1@example.com','$2a$10$5h2R8dWgP3JZ8/iPSJ..O.FydD5yIVdbTnfGt3gb0SKrWsFp.PfRO','user1'),(2,'seller1@example.com','$2a$10$hQKruzKmyRPdfnL6DQWioejUVuCN8q7a32KWS5KPn9sBmeoGSizYq','seller1'),(3,'admin@example.com','$2a$10$JRWiweIHkBwVBV/X3gInQOqEmNEF9GjmU.5berUNPjMWcN9FHsCCe','admin');
...
-- Dump completed on 2024-08-24 23:22:16
